...
module.exports = async (req, res) => {
    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            const result = await pool.query(
                'INSERT INTO installments (user_id, description, total_value, installment_value, total_installments, start_date) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id',
                [userId, description, totalValue, installmentValue, totalInstallments, startDate]
            );
